...
import { ArrowLeft, Download, Loader2, Sparkles, AlertCircle } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      <Link
        href="/"
        className="mb-6 inline-flex items-center gap-1.5 text-sm text-[var(--color-fg-muted)] transition-colors hover:text-[var(--color-fg)]"
      >
